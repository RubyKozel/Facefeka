...
var setGlobal = __webpack_require__(21);
var nativeFunctionToString = __webpack_require__(31);
...
var has = __webpack_require__(8);
var toIndexedObject = __webpack_require__(12);
var arrayIncludes = __webpack_require__(57);
var hiddenKeys = __webpack_require__(22);
...
var sloppyArrayMethod = __webpack_require__(69);
...
/* harmony import */ var core_js_modules_es_array_fill__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(62);
...
/* harmony import */ var core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(67);
/* harmony import */ var core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var core_js_modules_es_date_now__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(70);
...
/* harmony import */ var core_js_modules_es_date_to_string__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(71);
/* harmony import */ var core_js_modules_es_date_to_string__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_date_to_string__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(72);
/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var core_js_modules_es_object_values__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(74);
...
/* harmony import */ var core_js_modules_es_parse_int__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(76);
...
/* harmony import */ var core_js_modules_es_promise__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(79);
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(95);
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var core_js_modules_web_timers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(97);
...
/* harmony import */ var regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(98);
...
var play = function play() {
  ...
  var index = parseInt(localStorage.getItem('myIndex'));
  var type = 'status';
...
var draw = function draw(players) {
  var x = 0;
  context.clearRect(0, 0, canvasWidth, canvasHeight);
  players.forEach(function (_ref, i) {
    var y = _ref.y;
    context.beginPath();
...
var drawBall = function drawBall(_ref2) {
  var ballX = _ref2.ballX,
      ballY = _ref2.ballY;
  context.beginPath();
...
conn.onopen = function () {
  return init[localStorage.getItem('action')](localStorage.getItem('name'));
};
...
var initiateGame = function initiateGame(messages, index) {
...
var actions = {
  'name': function name(response) {
    for (var key in response.value) {
      if (response.value.hasOwnProperty(key)) document.getElementById(key).innerText = response.value[key];
    }
  },
  'subscribe': function subscribe(response) {
    localStorage.setItem('roomNumber', response.value);
  },
  'unsubscribe': function unsubscribe(response) {
  ...
  'players': function players(response) {
    draw(Object.values(response.value));
  },
  'ball': function ball(response) {
    drawBall(response.value);
  },
  'game over': function () {
    var _gameOver = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee2(response) {
      var element, _response, json, score;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              element = "player-".concat(response.value);
              ...
              _context2.next = 5;
              return fetch("".concat(base_url).concat(routes.add_score_by_id), {
                method: 'POST',
                mode: 'cors',
                headers: {
            ...
            case 5:
              ...
              if (!(_response.status && _response.status === 200)) {
                _context2.next = 14;
                break;
              }
            ...
            case 9:
              ...
              conn.send(JSON.stringify({
                type: 'alert_winner',
                value: score,
                winner: "".concat(document.getElementById(element).innerHTML)
              }));
              _context2.next = 15;
              break;
    ...
    function gameOver(_x2) {
      return _gameOver.apply(this, arguments);
    }

    return gameOver;
  }(),
  'alert_winner': function alert_winner(response) {
    var winner = response.winner;
    var winner_score = response.score;
    alert("".concat(winner, " has won!! his score is ").concat(winner_score, "!"));
  }
};
...
var global = __webpack_require__(0);
var internalStringTrim = __webpack_require__(78);
var whitespaces = __webpack_require__(45);
